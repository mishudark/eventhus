...
import (
	...
	"github.com/mishudark/eventhus/v2/commandbus/async"
	"github.com/mishudark/eventhus/v2/eventbus/mosquitto"
	"github.com/mishudark/eventhus/v2/eventbus/nats"
	"github.com/mishudark/eventhus/v2/eventbus/rabbitmq"
	"github.com/mishudark/eventhus/v2/eventstore/badger"
	"github.com/mishudark/eventhus/v2/eventstore/mongo"
)
...
type commandHandler func(repository *eventhus.Repository, aggregate eventhus.AggregateHandler, bucket, subset string) eventhus.CommandHandler
